...
echo "Replace 'REPO_HOST' with 'http://$REPO_HOST' and 'REPO_PORT' with '$REPO_PROTOCOL://$REPO_PORT'"

sed -i -e 's/http:\/\/REPO_HOST:REPO_PORT/'"$REPO_PROTOCOL:\/\/$REPO_HOST:$REPO_PORT"'/g' /usr/local/tomcat/shared/classes/alfresco/web-extension/share-config-custom.xml
